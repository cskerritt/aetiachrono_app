"""
Django settings for AetiaChrono project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-kHXBpneiZeunxiS3lZhXr6AIHKRX8bNOtJZE02ie")
...
ROOT_URLCONF = "aetiachrono_app.urls"
...
WSGI_APPLICATION = "aetiachrono_app.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="aetiachrono_app"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "aetiachrono_app_language"
LANGUAGES = [
...
EMAIL_SUBJECT_PREFIX = "[AetiaChrono] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "AetiaChrono",
    "DESCRIPTION": "Life Care Planning Application for Kincaid Wolstein Vocational and Rehabilitation Services",
    "VERSION": "0.1.0",
...
LOGGING = {
    ...
    "loggers": {
        ...
        "aetiachrono_app": {
            "handlers": ["console"],
            "level": env("AETIACHRONO_APP_LOG_LEVEL", default="INFO"),
        },
    },
}
